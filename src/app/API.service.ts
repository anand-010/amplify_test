...
export type OnaddtodoByIdSubscription = {
  __typename: "Todo";
  id: string;
  name: string;
  description: string | null;
...
export class APIService {
  ...
  OnaddtodoByIdListener: Observable<OnaddtodoByIdSubscription> = API.graphql(

    graphqlOperation(
      `subscription OnaddtodoById($id: ID!) {
        onaddtodoById(id: $id) {
          __typename
          id
          name
  ...
  ) as Observable<OnaddtodoByIdSubscription>;
